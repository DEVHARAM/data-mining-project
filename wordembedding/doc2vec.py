...
#                     yield TaggedDocument(words=line.split(), tags=['%s' % score])
#
#
# emoticons = ["!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "-", "=", "_", "+", "~", ",", ".", "?", "/", ">", "<", "\t"]
...
#         Out.write(read)
#
# doc2vec_corups = Doc2VecCorpus("public/first.txt")
# doc2vec_model = Doc2Vec(doc2vec_corups)
...
model_name = 'Doc2Vec(dbow+w,d300,n10,hs,w8,mc20,s0.001,t8).model'
